    ...
    , ui(new Ui::MainWindow)
{
    ...
    QIcon freeHandIcon(QPixmap(":/images/pen_icon.png"));
    ...
    QIcon eraserIcon(QPixmap(":/images/eraser_icon.png"));
    this->ui->eraserTool->setIcon(eraserIcon);
    this->ui->eraserTool->setToolTip(QString("Eraser Tool"));
    this->ui->eraserTool->setIconSize(QSize(48,48));
...
void MainWindow::mouseMoveEvent(QMouseEvent *e)
{
    ...
    if(i==6)
    {
     TMEraserComponent *tmEraserComponent=new TMEraserComponent;
     tmEraserComponent->setX1(oldX);
     tmEraserComponent->setY1(oldY);
     tmEraserComponent->setX2(currentX);
     tmEraserComponent->setY2(currentY);
     tmEraserComponent->setBorderColor(colorOfBorder);
     tmEraserComponent->setPenWidth(this->ui->horizontalSlider->value());
     tmView.add(tmEraserComponent);
     QWidget::update();
     oldX=currentX;
     oldY=currentY;
   }
...
void MainWindow::on_eraserTool_clicked()
{
    i=6;
}
